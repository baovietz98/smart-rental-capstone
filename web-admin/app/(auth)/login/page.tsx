    ...
    <div className="claude-card p-8 md:p-10 bg-white">
       ...
       >
          ...
          <div className="flex justify-between items-center mb-6">
             ...
             <Link className="text-[#D97757] hover:underline text-sm font-medium" href="/forgot-password">
                Forgot Password?
             </Link>
          </div>
       ...
       <div className="mt-6 text-center text-gray-500 border-t border-gray-100 pt-6">
          ...
          <Link href="/register" className="text-[#D97757] font-semibold hover:underline">
             Sign Up
          </Link>
       </div>
    </div>
